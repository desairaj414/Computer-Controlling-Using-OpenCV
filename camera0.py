...
class VideoCamera0(object):
    ...
    def segment(self, frame, threshold=30):
        # global background
    ...
    def get_frame(self):
        ...
        if self.num_frames < 60:
            VideoCamera0.calc_accum_avg(self, gray, self.accumulated_weight)
            ...
            hand = VideoCamera0.segment(self, gray)
            ...
            if hand is not None:
                ...
                # Count the fingers
                fingers = VideoCamera0.count_fingers(self, thresholded, hand_segment)

                # Display count
                cv2.putText(frame_copy, str(fingers), (70, 145), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)

                # Also display the thresholded image
                # cv2.imshow("Thesholded", thresholded)
                # print(thresholded.shape)
                # print(frame_copy[20:300, 300:600].shape)
                frame_copy[20:300, 300:600] = cv2.cvtColor(thresholded, cv2.COLOR_GRAY2BGR)
